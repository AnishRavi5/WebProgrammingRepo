...
def city_status():
    ...
    # TODO filled: Add month, year, params to op
    op['month'] = city_details.month
    op['year'] = city_details.year
    op['params'] = ','.join(city_details.params)
    app.logger.info(op)
...
def registercity():
    ...
    # TODO filled: Parse year and month
    ...
    # TODO filled: Parse and save min_temp, precipitation, snow
    ...
    # Check if city was registered by admin first
    present = False
...
# TODO filled: Admin login route
@app.route("/adminlogin", methods=['POST'])
def adminlogin():
    username = request.form['username'].strip()
    password = request.form['password'].strip()
    app.logger.info("Admin Username:%s", username)
